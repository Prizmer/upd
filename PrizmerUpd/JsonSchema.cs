...
namespace PrizmerUpdater
{
    ...
    public partial class RepositoryList
    {
        public static List<RepositoryList> FromJson(string json) => JsonConvert.DeserializeObject<List<RepositoryList>>(json, PrizmerUpdater.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<RepositoryList> self) => JsonConvert.SerializeObject(self, PrizmerUpdater.Converter.Settings);
    }
